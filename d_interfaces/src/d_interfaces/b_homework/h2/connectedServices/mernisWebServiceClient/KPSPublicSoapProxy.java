...
public class KPSPublicSoapProxy implements d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublicSoap {
  private String _endpoint = null;
  private d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
