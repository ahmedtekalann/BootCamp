...
public class KPSPublicLocator extends org.apache.axis.client.Service implements d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublic {
    ...
    public d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublicSoapStub _stub = new d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublicSoapStub _stub = new d_interfaces.b_homework.h2.connectedServices.mernisWebServiceClient.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
